 ...
 */
class Mwb_Cf7_Integration_Insightly_Framework {
	...
	public function get_avialable_form_filters() {
		...
		$filter = array(
			'exact_match'       => esc_html__( 'Matches exactly', 'mwb-cf7-integration-with-insightly' ),
			'no_exact_match'    => esc_html__( 'Does not match exactly', 'mwb-cf7-integration-with-insightly' ),
			'contains'          => esc_html__( 'Contains (Text)', 'mwb-cf7-integration-with-insightly' ),
			'not_contains'      => esc_html__( 'Does not contain (Text)', 'mwb-cf7-integration-with-insightly' ),
			'exist'             => esc_html__( 'Exist in (Text)', 'mwb-cf7-integration-with-insightly' ),
			'not_exist'         => esc_html__( 'Does not Exists in (Text)', 'mwb-cf7-integration-with-insightly' ),
			'starts'            => esc_html__( 'Starts with (Text)', 'mwb-cf7-integration-with-insightly' ),
			'not_starts'        => esc_html__( 'Does not start with (Text)', 'mwb-cf7-integration-with-insightly' ),
			'ends'              => esc_html__( 'Ends with (Text)', 'mwb-cf7-integration-with-insightly' ),
			'not_ends'          => esc_html__( 'Does not end with (Text)', 'mwb-cf7-integration-with-insightly' ),
			'less_than'         => esc_html__( 'Less than (Text)', 'mwb-cf7-integration-with-insightly' ),
			'greater_than'      => esc_html__( 'Greater than (Text)', 'mwb-cf7-integration-with-insightly' ),
			'less_than_date'    => esc_html__( 'Less than (Date/Time)', 'mwb-cf7-integration-with-insightly' ),
			'greater_than_date' => esc_html__( 'Greater than (Date/Time)', 'mwb-cf7-integration-with-insightly' ),
			'equal_date'        => esc_html__( 'Equals (Date/Time)', 'mwb-cf7-integration-with-insightly' ),
			'empty'             => esc_html__( 'Is empty', 'mwb-cf7-integration-with-insightly' ),
			'not_empty'         => esc_html__( 'Is not empty', 'mwb-cf7-integration-with-insightly' ),
		);
	...
	public function get_feed_title( $feed_id ) {
		$title = esc_html__( 'Feed #', 'mwb-cf7-integration-with-insightly' ) . $feed_id;
	...
	public function is_crm_connected() {
		$connect = get_option( 'mwb-cf7-' . $this->crm_slug . '-authorised', false );
	...
	public function get_available_crm_objects() {
		...
		$not_connected = esc_html__( 'Application is not connected to Insightly', 'mwb-cf7-integration-with-insightly' );
