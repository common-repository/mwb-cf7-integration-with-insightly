 ...
 */
class Mwb_Cf7_Integration_Insightly_Request_Module {
	...
	/**
	 * Main Mwb_Cf7_Integration_Insightly_Request_Module Instance.
	 *
	 * Ensures only one instance of Mwb_Cf7_Integration_Insightly_Request_Module is loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @return Mwb_Cf7_Integration_Insightly_Request_Module - Main instance.
	 */
	...
	public function get_crm_request( $crm_obj = false, $feed_id = false, $entries = array() ) {
		...
		if ( array_key_exists( 'DATE_OF_BIRTH', $response ) ) {
			$response['DATE_OF_BIRTH'] = gmdate( 'Y-m-d\TH:i:s.000\Z', strtotime( $response['DATE_OF_BIRTH'] ) );
		}
